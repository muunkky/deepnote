...
//
// The project arrives as a prop. Step 3 passed the in-memory `: ApiProject` fixture directly;
// step 4 made `App` the fetch container that resolves the real project and renders this Shell
// with it — so this view is identical whether the project came from a fixture or the wire.
...
export function Shell({ project }: ShellProps) {
